package com.neleso.common.playlist
    ...
    override fun getRootItem(context: Context): MediaBrowserCompat.MediaItem {
        return MediaBrowserCompat.MediaItem(
            MediaDescriptionCompat.Builder()
                ...
                .setIconUri((RESOURCE_ROOT_URI + context.resources.getResourceEntryName(R.drawable.ic_icon_library)).toUri())
                .setExtras(
                    Bundle().apply {
                        putBoolean(CONTENT_STYLE_SUPPORTED, true)
